...
class listmiddle(object):
    def __init__(self, front=None, back=None, _vars=[]):
    ...
    def __radd__(self, other):
        ...
        return listmiddle(other+self.front, self.back, _vars=self._vars)

    def __add__(self, other):
        if not isinstance(other, list):
            raise TypeError("Cannot add listmiddle and {} objects".format(type(other)))
        return listmiddle(self.front, self.back + other, _vars=self._vars)
